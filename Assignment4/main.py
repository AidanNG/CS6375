...
if __name__ == '__main__':
    ...
    lbs, color_centroids = k_means_clustering(image_vectors, k=K, iterations=itr)
    ...
    io.imsave('Koala20.jpg', output_image)
    print('Image Compression Completed')
    info = os.stat(jpg)
    print("Image size before : ", info.st_size / 1024, "KB")
    info = os.stat('Koala20.jpg')
