...
def id3(x, y, attribute_value_pairs=None, depth=0, max_depth=5):
    ...
    * Leaf nodes are (majority) class labels
    ...
    try:
        return {
            (best_attr, value, False): id3(x[indexes_if_false], y[indexes_if_false], attribute_value_pairs, depth + 1,
                                           max_depth),
            (best_attr, value, True): id3(x[indexes_if_true], y[indexes_if_true], attribute_value_pairs, depth + 1,
                                          max_depth)}
    except:
        return majority_y
...
def render_dot_file(dot_string, save_file, image_format='png'):
    ...
    os.environ[
        "PATH"] += os.pathsep + 'C:/Program Files/Graphviz/bin/'  # 'C:/Users/anu07/graphviz-2.38/release/bin'
